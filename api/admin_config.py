...
FIELDS: tuple[ConfigFieldSpec, ...] = (
    ...
    ConfigFieldSpec(
        ...
        "providers",
        "secret",
        settings_attr="aerolink_api_key",
        secret=True,
        description="Global fallback API key for Aerolink (aero_live_...).",
    ),
    ConfigFieldSpec(
        "AEROLINK_API_KEY_OPUS",
        "Aerolink Opus API Key",
        "providers",
        "secret",
        settings_attr="aerolink_api_key_opus",
        secret=True,
        description="Aerolink API key specifically used for Opus model requests.",
    ),
    ConfigFieldSpec(
        "AEROLINK_API_KEY_SONNET",
        "Aerolink Sonnet API Key",
        "providers",
        "secret",
        settings_attr="aerolink_api_key_sonnet",
        secret=True,
        description="Aerolink API key specifically used for Sonnet model requests.",
    ),
    ConfigFieldSpec(
        "AEROLINK_API_KEY_HAIKU",
        "Aerolink Haiku API Key",
        "providers",
        "secret",
        settings_attr="aerolink_api_key_haiku",
        secret=True,
        description="Aerolink API key specifically used for Haiku model requests.",
    ),
    ConfigFieldSpec(
        "AEROLINK_BASE_URL",
        "Aerolink Base URL",
        "providers",
        settings_attr="aerolink_base_url",
        default="https://capi.aerolink.lat/v1",
        description="Custom base URL for Aerolink (defaults to https://capi.aerolink.lat/v1).",
    ),
    ConfigFieldSpec(
        "LM_STUDIO_BASE_URL",
        "LM Studio Base URL",
    ...
    ConfigFieldSpec(
        ...
        "Fallback Chain",
        "models",
        settings_attr="fallback_chain",
        description="Comma-separated fallback provider list, e.g. aerolink,github_models,groq",
    ),
    ConfigFieldSpec(
        "PROVIDER_TIMEOUT",
        "Provider Timeout",
        "models",
        "number",
        settings_attr="provider_timeout",
        default="30.0",
    ...
    ConfigFieldSpec(
        ...
        "models",
        "number",
        settings_attr="heartbeat_interval",
        default="60",
        description="Background heartbeat checker ping interval in seconds.",
    ),
    ConfigFieldSpec(
        "BLACKOUT_WINDOWS",
        "Blackout Windows",
        "models",
        settings_attr="blackout_windows",
        description="Time window when provider is blacked out, e.g. aerolink=02:00-04:00",
    ),
    ConfigFieldSpec(
